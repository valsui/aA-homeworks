...
var GiphysIndex = function GiphysIndex(props) {
  return _react2.default.createElement(
    'ul',
    null,
    props.giphys.map(function (gif) {
      return _react2.default.createElement(_giphys_index_item2.default, { key: gif.id, gif: gif });
    })
  );
};
...
var GiphysIndexItem = function GiphysIndexItem(_ref) {
  var embed_url = _ref.embed_url;
  return _react2.default.createElement(
    'li',
    null,
    _react2.default.createElement('img', { src: '{embed_url}' })
  );
};
...
var GiphysSearch = function (_React$Component) {
  ...
  _createClass(GiphysSearch, [{
    ...
    value: function handleSubmit(event) {
      ...
      this.props.fetchSearchGiphys(this.state).then(function (resp) {
